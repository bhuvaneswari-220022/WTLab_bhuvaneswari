...
// ====== LOAD .ENV ====== 
$envPath = __DIR__ . 'C:\xampp\htdocs\php_QuickResume\Task01_QuickResume\.env';  // from OAuth2.0/ go up to Itsmypage/ 
...
echo "<br><br><a href='exmaple.html'>Go back to Home</a>